...
-- CreateEnum
CREATE TYPE "PropertyType" AS ENUM ('Rooms', 'Tinyhouse', 'Apartment', 'Villa', 'Townhouse', 'Cottage', 'Land');
...
-- AddForeignKey
ALTER TABLE "Property" ADD CONSTRAINT "Property_buyerCognitoId_fkey" FOREIGN KEY ("buyerCognitoId") REFERENCES "Tenant"("cognitoId") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "LandDetail" ADD CONSTRAINT "LandDetail_propertyId_fkey" FOREIGN KEY ("propertyId") REFERENCES "Property"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Purchase" ADD CONSTRAINT "Purchase_buyerCognitoId_fkey" FOREIGN KEY ("buyerCognitoId") REFERENCES "Tenant"("cognitoId") ON DELETE RESTRICT ON UPDATE CASCADE;
